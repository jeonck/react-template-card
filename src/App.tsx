...
function App() {
  return (
    <Router basename="/react-template-card/">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="text-center md:text-left mb-4 md:mb-0">
          <p className="text-lg font-semibold text-gray-800">React Template Card</p>
          <p className="text-sm text-gray-600">The Future of Virtual Replication and Simulation</p>
        </div>
        <div className="text-sm text-gray-600">
          <p>&copy; {new Date().getFullYear()} React Template Card. All rights reserved.</p>
        </div>
      </div>
    </div>
  </footer>
